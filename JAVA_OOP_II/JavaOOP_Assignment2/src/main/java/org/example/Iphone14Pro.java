...
public class Iphone14Pro extends Iphone {
    ...
    public Iphone14Pro(String color, String material, String imei) {
        super(color, material, 2500);
        this.imei =imei;
        this.contacts=new LinkedHashSet<>(300);
